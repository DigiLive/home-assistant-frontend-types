...
export declare const subscribeLogbook: (hass: HomeAssistant, callbackFunction: (message: LogbookStreamMessage) => void, startDate: string, endDate: string, entityIds?: string[], deviceIds?: string[]) => Promise<UnsubscribeFunc>;
...
export declare const filterLogbookCompatibleEntities: HaEntityComboBoxEntityFilterFunc;
