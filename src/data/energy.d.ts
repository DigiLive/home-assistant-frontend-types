...
export declare const getEnergyGasUnit: (hass: HomeAssistant, prefs: EnergyPreferences, statisticsMetaData?: Record<string, StatisticsMetaData>) => string;
...
export declare const formatConsumptionShort: (hass: HomeAssistant, consumption: number | null, unit: string) => string;
