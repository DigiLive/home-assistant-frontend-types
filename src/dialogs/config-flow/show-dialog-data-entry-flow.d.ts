...
export interface FlowConfig {
    ...
    renderAbortHeader?(hass: HomeAssistant, step: DataEntryFlowStepAbort): TemplateResult | string;
    renderAbortDescription(hass: HomeAssistant, step: DataEntryFlowStepAbort): TemplateResult | string;
    renderShowFormStepHeader(hass: HomeAssistant, step: DataEntryFlowStepForm): string | TemplateResult;
    ...
    renderShowFormProgressHeader(hass: HomeAssistant, step: DataEntryFlowStepProgress): string | TemplateResult;
    renderShowFormProgressDescription(hass: HomeAssistant, step: DataEntryFlowStepProgress): TemplateResult | "";
    renderMenuHeader(hass: HomeAssistant, step: DataEntryFlowStepMenu): string | TemplateResult;
