...
import type { FullCalendarView, ThemeMode, TranslationDict } from "../../../types";
...
import type { EntityConfig, EntityFilterEntityConfig, LovelaceRowConfig } from "../entity-rows/types";
