...
export declare const selectedThemeContext: {
    __context__: import("../types").ThemeSettings | null;
};
export declare const userContext: {
    __context__: import("../types").CurrentUser | undefined;
};
export declare const userDataContext: {
    __context__: import("./frontend").CoreFrontendUserData | null | undefined;
};
