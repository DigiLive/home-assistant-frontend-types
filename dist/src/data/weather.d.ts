import type { HassConfig, HassEntityAttributeBase, HassEntityBase } from "home-assistant-js-websocket";
...
export declare const getDefaultForecastType: (stateObj: HassEntityBase) => "hourly" | "daily" | "twice_daily" | undefined;
export {};
