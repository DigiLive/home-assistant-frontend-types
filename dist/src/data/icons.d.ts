...
export declare const entityIcon: (hass: HomeAssistant, stateObj: HassEntity, state?: string) => Promise<string | undefined>;
export declare const entryIcon: (hass: HomeAssistant, entry: EntityRegistryEntry | EntityRegistryDisplayEntry) => Promise<string | undefined>;
export declare const attributeIcon: (hass: HomeAssistant, state: HassEntity, attribute: string, attributeValue?: string) => Promise<string | undefined>;
