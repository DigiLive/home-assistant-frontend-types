...
export declare const getCustomCardEntry: (type: string) => CustomCardEntry | undefined;
export declare const getCustomBadgeEntry: (type: string) => CustomBadgeEntry | undefined;
