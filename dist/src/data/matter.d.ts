...
export declare const canCommissionMatterExternal: (hass: HomeAssistant) => boolean | undefined;
export declare const startExternalCommissioning: (hass: HomeAssistant) => Promise<void>;
