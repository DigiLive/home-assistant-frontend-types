...
export declare const isHelperDomain: (searchElement: unknown, fromIndex?: number) => searchElement is "schedule" | "counter" | "timer" | "input_text" | "input_number" | "input_select" | "input_boolean" | "input_button" | "input_datetime";
