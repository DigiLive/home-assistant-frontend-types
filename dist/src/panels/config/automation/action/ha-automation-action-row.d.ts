...
export declare const getType: (action: Action | undefined) => "event" | "parallel" | "stop" | "repeat" | "action" | "service" | "sequence" | "play_media" | "delay" | "wait_template" | "wait_for_trigger" | "condition" | "device_id" | "choose" | "if" | "variables" | "set_conversation_response" | undefined;
